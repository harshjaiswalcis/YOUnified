...
class GrievancesList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, String>> filteredGrievances = grievances.where((grievance) {
      if (isOpen) {
        return grievance['stage'] == 'Stage 2'; // Show Stage 2 when `isOpen` is true
      } else {
        return grievance['stage'] == 'Closed'; // Show Closed when `isOpen` is false
      }
    }).toList();
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      DecoratedBox(
                        decoration: BoxDecoration(
                          color: isOpen == true && grievance['stage'] != "Closed" ? AppColors.yellowContainerbg : AppColors.greenContainerbg,
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: context.textTheme.labelMedium!
                                .copyWith(color: isOpen == true && grievance['stage'] != "Closed" ? AppColors.yellowTextColor : AppColors.backGround),
                          ),
                        ),
                      ) ,
                    ],
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(context.strings.lastUpdatedOn,
                              style: context.textTheme.bodySmall!
                                  .copyWith(fontWeight: FontWeight.w300),),
                            Text(grievance['updated'].toString(),
                              style: context.textTheme.bodySmall,),
                          ],
                        ),
                      ),
